          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-200 text-slate-700 flex items-center justify-center hover:bg-slate-300 hover:text-slate-900 transition-colors"
              >
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-200 text-slate-700 flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={link.label}>
                  <Link href={link.href} className="text-sm hover:text-slate-900 transition-colors flex items-center gap-2">
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1.5">
            ...
            <p className="text-xs text-slate-400">
              Designed, Developed & SEO Managed by <a href="https://www.zoomdigital.in" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-slate-900 font-medium transition-colors">Zoom Digital</a>
            </p>
          </div>
